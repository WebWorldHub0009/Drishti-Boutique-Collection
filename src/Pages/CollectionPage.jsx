...
import HeroBG from "../assets/images/gallery/bg.jpg"; // replace with your hero image
import { baseUrls } from "../baseUrls";

const BeautyPage = ({ addToCart, category = "soaps", title }) => {
    ...
    const pageTitle = title || category.charAt(0).toUpperCase() + category.slice(1);
            ...
            <section className="relative h-[80vh] w-full overflow-hidden">
                ...
                <div className="relative z-10 flex items-center justify-center h-full text-center text-white px-6">
                    <div>
                        ...
                        >
                            Premium, natural, and effective {pageTitle} for your daily beauty care.
                        </motion.p>
                        <motion.button
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <p className="italic text-[#444]">
                        "Natural, gentle, and crafted for your beauty."
                    </p>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <div className="w-full md:w-1/2 h-full p-6 md:p-8 flex flex-col overflow-y-auto hide-scrollbar bg-[#fffaf5]">
                            ...
                            <p className="text-base md:text-lg text-[#444] mb-6">{modal.description}</p>
                            <p className="text-xl font-bold text-[#D4AF37] mb-6">₹{modal.price}</p>
