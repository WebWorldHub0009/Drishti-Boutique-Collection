...
import royal15 from "../assets/images/color/s16.jpg";
...
import royal11 from "../assets/images/lehnga/l2.jpg";
import royal12 from "../assets/images/lehnga/l4.jpg";
import royal13 from "../assets/images/saree/yellow.jpg"
import royal14 from "../assets/images/saree/blue.jpg"
  ...
  },
{
  ...
  {
  title: "Blue Heavy Bridal Lehenga",
  image: royal11,
  description:
    "Stunning heavy bridal lehenga in royal blue, featuring intricate embroidery and rich embellishments — perfect for grand wedding celebrations.",
},
{
  title: "Heavy Bridal Lehenga",
  image: royal12,
  description:
    "Luxurious bridal lehenga designed with detailed handwork, premium fabrics, and exquisite traditional motifs — crafted for timeless bridal elegance.",
},
{
  title: "Premium Yellow Saree",
  image: royal13,
  description:
    "Bright and radiant yellow saree with fine detailing and soft fabric flow — ideal for festive mornings, haldi ceremonies, and joyful celebrations.",
},
{
  title: "Classic Blue Saree",
  image: royal14,
  description:
    "Elegant classic blue saree with minimalistic charm and graceful drape — perfect for formal events, cultural gatherings, and evening parties.",
},
        ...
        >
          ...
          >
            ...
            <div className="p-8 flex flex-col justify-center text-center md:text-left bg-[#fffaf5]">
              ...
              <p className="text-sm font-medium text-[#444] mb-2"><span className="font-bold text-[#B22222]">Fabric Type:</span> {modal.fabric}</p>
              <p className="text-sm font-medium text-[#444] mb-6"><span className="font-bold text-[#B22222]">Work Detailing:</span> {modal.work}</p>
              <a
