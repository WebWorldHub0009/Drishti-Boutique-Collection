            ...
            <section className="relative h-[80vh] w-full overflow-hidden">
                ...
                <div className="relative z-10 flex items-center justify-center h-full text-center text-white px-6">
                    <div>
                        ...
                        >
                            Explore our premium {category.replace("-", " ")} collection made with natural ingredients & care.
                        </motion.p>
                        <motion.button
                ...
                >
                    ...
                    >
                        ...
                        <div className="w-full md:w-1/2 h-[40vh] md:h-full flex items-center justify-center bg-[#f7f5f0]">
                            <img src={modal.image} alt={modal.title} className="max-w-full max-h-full object-contain" />
                        </div>
